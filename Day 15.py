...
def update_resources(drink):
    """Compare amount of resources needed for drink to amount available"""
...
def add_to_total(current_total):
    """Adds the amount of money for an order to the total earned"""
...
def coin_counter(drinks):
    """Returns amount of change owed & checks if user submited enough money"""
    current_spent=0
    keep_running=True
    while keep_running:
